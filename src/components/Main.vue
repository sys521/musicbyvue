    ...
    <div id="main">
        <div class="topbar">
          <header>
            ...
            <a class="download-btn">下载APP</a>
          </header>
          <nav >
            <router-link class="link" to="/recommend" ><li v-bind:class="{current:routerActive==0}" @click=" routerActive=0">推荐音乐</li></router-link>
            <router-link  class="link" to="/hot" ><li v-bind:class="{current:routerActive==1}" @click=" routerActive=1">热歌榜</li></router-link>
            <router-link  class="link" to="/find"><li v-bind:class="{current:routerActive==2}" @click=" routerActive=2">搜索</li></router-link>
          </nav>
        </div>
        <div class="layout">
  ...
  #main{
    .topbar{
      ...
      nav >.link{
        ...
        .current:after{
          border-bottom:0.2rem solid #d33a31;
          display:block;
          content:'';
          position: absolute;
          bottom:0;
