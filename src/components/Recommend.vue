<template>
    <div id="recommend">
      <div class="last-music">
        ...
        <div class="last-list">
          <li>
            <img src="http://p1.music.126.net/MFf56dl-NrFJCEAPCrWwUA==/18578447976559047.webp?imageView&thumbnail=246x0&quality=75&tostatic=0&type=webp">
            <span>xxxx</span>
            <p>七夕快到了，单身狗有话要说……</p>
          </li>
          <li>
...
<script>
    ...
    export default {
        ...
        created:function(){
          var that=this
          this.$store.dispatch('getLast').then(function(){
            that.getlist()
          })
        },
        methods:{
          getlist:function(){
            console.log('获取最新音乐')
            this.newlist = this.$store.state.newMusic
          }
        }
    }
</script>
...
<style lang="scss">
  .last-music>h2{
    ...
    font-weight:300;
    padding:0 1rem;
    border-left:0.2rem solid #d33a31;
  }
  .last-list{
    display:flex;
    flex-wrap: wrap;
